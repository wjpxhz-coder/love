...
// ── 版本与更新日志 ──
const APP_VERSION = 'v3.9.17';
const CONFIG = {
    version: 'v3.9.17',
    date: '2026-08-25',
    title: '心情日历“标记这一天”金光特效上线 ✨💛',
    features: [
        '心情打卡与编辑界面支持「标记这一天」，随时记录专属高光时刻 ✨',
        '标记后的日子在心情日历主页以璀璨金光呼吸流光动态展示 🌟',
        '单日心情详情页同步展示高光纪念日标识与金致卡片质感 🏷️',
        '双向智能兼容与弹性持久化，守护每一天的甜蜜回忆 💖'
    ]
};
