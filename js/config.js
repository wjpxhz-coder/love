...
// ── 版本与更新日志 ──
const APP_VERSION = 'v3.9.13';
const UPDATE_LOG = {
    version: 'v3.9.13',
    date: '2026-08-22',
    title: '存储管理与缓存清理独立化升级 🧹📦',
    features: [
        '空间存储拆分为「网页缓存清理」与「本地照片缓存清理」双独立控制 🧹',
        '清除网页缓存时智能保留本地已缓存的照片，网站更新不再重复下载大图 ⚡',
        '实时动态统计并显示已缓存照片/媒体的占用空间大小 📊',
        '支持一键单独清理本地照片缓存，释放设备存储更清晰可控 ✨'
    ]
};
